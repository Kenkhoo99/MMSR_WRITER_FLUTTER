...
//Published Books (Writer) 
class LoadBookWriter extends StatefulWidget { 
  ...
  @override
  _LoadBookWriterState createState() => new _LoadBookWriterState();
}
            ...
            return new FutureBuilder<List>(
              ...
              builder: (context, snapshot2) {
                return snapshot2.hasData
                    ? new WriterPublish(//Push to the page to display all book
...
class WriterPublish extends StatefulWidget {
  ...
  @override
  _WriterPublishState createState() => new _WriterPublishState();
}
